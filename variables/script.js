...
let result = 2 + "4.5" > "5";  // It will be "24.5" > "5" As JS compares strings alphabetically so compares '2' against '5'. As 2 is less then 5 so answer will be False.
...
console.log(typeof available);  // object
